    ...
    <section className="m-[0.5rem] xl:mx-[10rem] overflow-x-hidden">
      {loading ? (
        <div className="flex justify-center items-center h-[300px]">
          <LoadingSpinner /> {/* Custom loader used here */}
        </div>
      ) : (
        <>
          <div className="flex justify-between items-center my-3">
            <h2 className="text-2xl font-semibold uppercase">New Products</h2>
          ...
          <Slider {...settings}>
            {products.map((product, index) => (
              ...
              >
                <div className="w-full h-auto rounded hover:rounded-none shadow-sm border hover:border-2 hover:border-[#ff5a00] p-2.5 transition-all hover:text-[#ff5a00] group relative">
                  <div className="relative">
                    <div className="absolute z-10 w-full flex justify-between items-start gap-1">
                      ...
                      <div className="md:flex items-center gap-1">
                        {index < 5 && ( // Show "NEW" label for the first 5 products only
                          <p className="hidden md:flex bg-[#ff5a00] text-center right-0 text-white text-xs md:text-md rounded-full px-2.5 p-0.5">
                            New
                          </p>
                        )}
                        {product.status === 'Out of Stock' && (
                          <p className="bg-[#ff5a00] text-center right-0 text-white text-xs md:text-md rounded-full px-2.5 p-0.5">
                            Stock Out
                          </p>
                        )}
                        {index < 5 && ( // Show "New" label for the first 5 products only
                          <p className="md:hidden ml-auto w-fit bg-[#ff5a00] text-center right-0 text-white text-xs md:text-md rounded-full px-2.5 p-0.5 mt-0.5">
                            New
                          </p>
                        )}
                      </div>
